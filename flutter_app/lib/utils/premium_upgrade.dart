...
void mostrarAvisoUpgrade(BuildContext context) {
  showDialog<void>(
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: const Text(
        'Assine o plano para ter acesso total: relatórios PDF, comprovantes e gestão completa. Sistema sem propagandas indesejáveis, limpo e seguro.',
...
void mostrarAvisoLicencaVencida(BuildContext context) {
  showDialog<void>(
    ...
    builder: (ctx) => AlertDialog(
      ...
      content: const Text(
        'Sua licença está vencida. Você pode visualizar todos os módulos, mas não pode lançar, editar, remover ou alterar dados em: Financeiro (Despesa/Receita), Meta, Escalas, Calculadora Banco de Horas, Produtividade/Ocorrências, Relatórios, Audiências/Compromissos, Downloads e Configurações.\n\nRenove agora para voltar a usar o app por completo.',
      ),
      actions: [
        TextButton(
          onPressed: () => Navigator.of(ctx).pop(),
