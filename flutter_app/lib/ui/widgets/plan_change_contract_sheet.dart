                  ...
                  children: [
                    _TermSection(
                      ...
                      body:
                          ...
                          'bem como os Termos de Uso e a Política de Privacidade do Controle Total disponíveis no app e no site.',
                    ),
                    _TermSection(
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 12, color: context.appTextMuted, height: 1.4, fontStyle: FontStyle.italic),
                    ),
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(title, style: TextStyle(fontWeight: FontWeight.w800, fontSize: 15, color: context.appTextPrimary)),
          SizedBox(height: 6),
          Text(
            body,
