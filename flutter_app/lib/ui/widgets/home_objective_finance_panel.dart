...
/// Card «Meta Financeira» no Início — Projeto 52 semanas + progresso (padrão WISDOMAPP).
          ...
          children: [
            ...
            if (hiddenCount > 0) ...[
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                  hiddenCount == 1
                      ? 'Veja mais 1 meta em Meta Financeira'
                      : 'Veja mais $hiddenCount metas em Meta Financeira',
