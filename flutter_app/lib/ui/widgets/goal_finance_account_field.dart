    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content:
                  Text('Cofrinho / caixa pessoal criado e vinculado à meta.')),
        );
      }
    } catch (e) {
      if (context.mounted) {
          ...
          builder: (ctx, setLocal) {
            return Padding(
              ...
              child: Container(
                ...
                decoration: ModernModuleUI.previewSheetDecoration(ctx),
                    ...
                    children: [
                      ...
                      FilledButton.icon(
                        onPressed: () async {
                          try {
                            final id =
                                await FinanceAccountsService().addAccount(
                              uid: uid,
                              presetId: preset.id,
                              productType: FinanceAccount.kChecking,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style:
                    TextStyle(fontSize: 10.5, color: context.appTextSecondary),
                overflow: TextOverflow.ellipsis,
              ),
            ],
          ),
  ...
  Widget _buildAccountDropdown(
    ...
    return DropdownButtonFormField<String?>(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon:
            Icon(Icons.savings_rounded, color: Colors.teal.shade700, size: 22),
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            border: borderColor != null
                ? Border.all(
                    color: borderColor.withValues(alpha: 0.45), width: 2)
                : null,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(icon,
                      color: light ? Colors.white : borderColor, size: 22),
                ),
                SizedBox(width: 12),
                Expanded(
                  child: Column(
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text(
              'Cofrinho',
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Colors.green.shade800),
            ),
        ...
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text(
              'Novo banco',
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Colors.indigo.shade800),
            ),
            style: OutlinedButton.styleFrom(
              padding: const EdgeInsets.symmetric(vertical: 10),
  ...
  Widget _buildFieldShell({required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: const Color(0xFF0D9488).withValues(alpha: 0.28)),
      ),
      child: child,
    );
  }
