...
class _AgendaPeriodFilterBarState extends State<AgendaPeriodFilterBar> {
  ...
  Widget _periodChip({
    ...
    if (_onGradient) {
      ...
      final idleBg = context.appChipIdleBg;
      final idleBorder = context.appChipIdleBorder;
      final idleText = context.appTextSecondary;
      final idleIcon = context.appTextMuted;
      if (segmented) {
        iconColor = selected ? accent : idleIcon;
        textColor = selected ? accent : idleText;
        decoration = BoxDecoration(
        ...
        iconColor = selected ? Colors.white : (dark ? const Color(0xFFCBD5E1) : AppColors.primary);
        textColor = selected ? Colors.white : (dark ? const Color(0xFFCBD5E1) : AppColors.primary);
        decoration = BoxDecoration(
          borderRadius: BorderRadius.circular(16),
          gradient: selected
  ...
  Widget _customDateField({
    ...
    return FastTextField(
      ...
      decoration: InputDecoration(
        ...
        fillColor: onGrad
            ? Colors.white
            : (dark ? context.appInputFill : AppColors.primary.withValues(alpha: 0.06)),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: onGrad
              ? BorderSide(color: Colors.white.withValues(alpha: 0.5))
              : BorderSide(color: context.appBorderSubtle),
        ),
