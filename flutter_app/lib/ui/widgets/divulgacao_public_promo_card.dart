...
import 'package:gestao_yahweh/constants/promo_site_urls.dart';
import 'package:gestao_yahweh/ui/pages/payment_status_page.dart';
import 'package:gestao_yahweh/utils/pwa_install_helper.dart';
...
class PublicDivulgacaoPromo {
  ...
  static bool _isEligible(Map<String, dynamic> m) {
    ...
    if (vf != null) {
      final from =
          DateTime(vf.toDate().year, vf.toDate().month, vf.toDate().day);
  ...
  static PublicDivulgacaoPromo? _fromDoc(
  ...
  factory PublicDivulgacaoPromo.fromLoadedPromotionDoc(
          ...
          children: [
            ...
            TextButton(
              ...
              child: Text(
                'Agora não',
                style: TextStyle(
                    color: slate400, fontWeight: FontWeight.w600, fontSize: 15),
              ),
            ),
          ],
        ),
