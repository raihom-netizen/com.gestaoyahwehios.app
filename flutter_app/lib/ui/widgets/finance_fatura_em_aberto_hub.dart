      ...
      child: InkWell(
        ...
        child: Container(
          padding: EdgeInsets.symmetric(
            horizontal: webTight ? 14 : (compact ? 18 : 20),
            vertical: webTight ? 10 : (compact ? 15 : 16),
          ),
          decoration: BoxDecoration(
            gradient: LinearGradient(
          ...
          child: Row(
            children: [
              Container(
                padding: EdgeInsets.all(webTight ? 8 : 10),
                decoration: BoxDecoration(
                  color: Colors.white.withValues(alpha: 0.2),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Icon(Icons.credit_card_rounded, color: Colors.white, size: webTight ? 20 : 24),
              ),
              SizedBox(width: webTight ? 10 : 14),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(
                      'Fatura em aberto',
                      style: TextStyle(
                        fontSize: webTight ? 13 : 14,
                        fontWeight: FontWeight.w800,
                        color: Colors.white.withValues(alpha: 0.98),
                      ),
                    ),
                    SizedBox(height: webTight ? 2 : 4),
                    Text(
                      _subtitle(),
                      style: TextStyle(
                        fontSize: webTight ? 10 : 11,
