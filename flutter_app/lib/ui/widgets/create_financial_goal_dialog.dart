          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text('Prioridade', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
                SizedBox(height: 6),
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                ...
                CheckboxListTile(
                  ...
                  title: Text('Lembrar de aportar todo mês', style: TextStyle(fontSize: 14)),
                  controlAffinity: ListTileControlAffinity.leading,
                  contentPadding: EdgeInsets.zero,
                ),
              ],
...
Widget _dialogTitleRow(BuildContext context, {required IconData icon, required String title}) {
  return Row(
