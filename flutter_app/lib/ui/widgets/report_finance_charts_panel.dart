              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.show_chart_rounded, color: _kEmerald, size: 22),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: Text(
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.account_balance_wallet_rounded, color: _kEmerald, size: 22),
              ),
              SizedBox(width: 10),
              Expanded(
                child: Text(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: context.appTextPrimary),
                  ),
                  SizedBox(height: 8),
                  SizedBox(
