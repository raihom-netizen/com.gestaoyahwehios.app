              ...
              child: Row(
                children: [
                  ...
                  FilledButton.tonal(
                    ...
                    child: Text('Veja mais', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 12.5)),
                  ),
                ],
              ),
            ),
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (ctx) => DraggableScrollableSheet(
      ...
      builder: (_, scrollCtrl) => Container(
        decoration: financePremiumSheetDecoration(surfaceTint: AppColors.amber, context: context),
        child: Column(
          children: [
