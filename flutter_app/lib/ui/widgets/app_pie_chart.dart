...
class AppPieChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (segments.isEmpty) {
      return _shell(context: context, title: title, child: Center(child: Text('Sem dados')));
    }
  ...
  Widget _shell({required BuildContext context, required String title, required Widget child}) {
    return Container(
