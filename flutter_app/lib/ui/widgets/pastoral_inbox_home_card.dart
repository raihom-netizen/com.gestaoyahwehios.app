              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Confirme a leitura ou envie uma resposta. Itens confirmados somem desta lista.',
                      style: TextStyle(
                        fontSize: 12.5,
                        height: 1.35,
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    hintText: 'Responder (opcional)',
                    hintStyle: TextStyle(
                      color: ThemeCleanPremium.onSurfaceVariant.withValues(alpha: 0.85),
                    ),
                    filled: true,
                ...
                Align(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      OutlinedButton(
                        onPressed: _saving ? null : () => _submit(includeReply: false),
                        ...
                        child: Text(_saving ? 'Enviando…' : 'OK — Li e entendi'),
                      ),
                      FilledButton(
                        onPressed: (_saving || !hasReply)
                            ? null
