    ...
    child: InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(22),
          color:
              selected ? accent.withValues(alpha: 0.12) : context.appChipIdleBg,
          border: Border.all(
...
class FinanceTransactionsFullscreenPage extends StatefulWidget {
  ...
  @override
  State<FinanceTransactionsFullscreenPage> createState() =>
      _FinanceTransactionsFullscreenPageState();
}

class _FinanceTransactionsFullscreenPageState
    extends State<FinanceTransactionsFullscreenPage> {
  ...
  Future<void> _confirmPaymentWithOptimistic(
  ...
  List<String> _categoriesForDropdown(
      List<QueryDocumentSnapshot<Map<String, dynamic>>> afterBase) {
    final s = <String>{};
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 8),
                Text(
                  day == null ? 'Sem data' : DateTimeFormats.formatDate(day),
                  style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w800,
              ...
              child: SafeArea(
                ...
                child: StreamBuilder<List<FinanceAccount>>(
                  ...
                  builder: (context, accSnap) {
                    ...
                    if (_mergedLoadError != null) {
                      return Center(
                        child: Padding(
                          ...
                          child: Text('Erro ao carregar: $_mergedLoadError',
                              textAlign: TextAlign.center),
                        ),
                      );
                    }
                    if (_mergedLoading &&
                        (_mergedDocs == null || _mergedDocs!.isEmpty)) {
                      return Padding(
                          padding: EdgeInsets.all(16),
                          child:
                              SkeletonListLoader(itemCount: 8, itemHeight: 72));
                    }

                    final raw = _mergedDocs ??
                    ...
                    final accountFilterValid = _financeAccountFilterId ==
                            null ||
                        accounts.any((a) => a.id == _financeAccountFilterId);
                    ...
                    String? categoryDropdownValue() {
                      ...
                      final stillInPeriod = raw.any((doc) {
                        final c =
                            (doc.data()['category'] ?? '').toString().trim();
                        return FinanceCategoryMerger.sameCategoryGroup(
                            c, _categoryFilter!);
                      });
                    ...
                    if (_categoryFilter != null) {
                      final inOptions = categoryOptions.any((o) =>
                          FinanceCategoryMerger.sameCategoryGroup(
                              o, _categoryFilter!));
                      if (!inOptions &&
                          raw.any((doc) {
                            final c = (doc.data()['category'] ?? '')
                                .toString()
                                .trim();
                            return FinanceCategoryMerger.sameCategoryGroup(
                                c, _categoryFilter!);
                    ...
                    if (!accountFilterValid &&
                      ...
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                        if (mounted) {
                          setState(() => _financeAccountFilterId = null);
                        }
                      });
                    }
                    ...
                    final nShow = docs.length < _txDisplayLimit
                        ? docs.length
                        : _txDisplayLimit;
                    final docsVisible =
                        nShow == docs.length ? docs : docs.sublist(0, nShow);
                                ...
                                children: [
                                        ...
                                        Expanded(
                                          child: OutlinedButton.icon(
                                            ...
                                            icon: Icon(
                                                ...
                                                size: 18),
                                            label: Text(
                                                'De ${_customRangeStart?.day ?? _from.day}/${_customRangeStart?.month ?? _from.month}'),
                                          ),
                                        ),
                                        SizedBox(width: 8),
                                        Expanded(
                                          child: OutlinedButton.icon(
                                            ...
                                            icon: Icon(Icons.event_rounded,
                                                size: 18),
                                            label: Text(
                                                'Até ${_customRangeEnd?.day ?? _to.day}/${_customRangeEnd?.month ?? _to.month}'),
                                          ),
                                        ),
                                      ],
                                    ),
                                  ...
                                  DropdownButtonFormField<String>(
                                    ...
                                    items: const [
                                      ...
                                      DropdownMenuItem(
                                          value: 'income',
                                          child: Text('Só receitas')),
                                      DropdownMenuItem(
                                          value: 'expense',
                                          child: Text('Só despesas')),
                                    ],
                                    onChanged: (v) {
                                      if (v == null) return;
                                      setState(() {
                                  ...
                                  SizedBox(height: 12),
                                  DropdownButtonFormField<String?>(
                                    key: ValueKey<String?>(accountFilterValid
                                        ? _financeAccountFilterId
                                        : null),
                                    initialValue: accountFilterValid
                                        ? _financeAccountFilterId
                                        : null,
                                    decoration: const InputDecoration(
                                      labelText: 'Conta',
                                  ...
                                  Builder(
                                    builder: (context) {
                                      ...
                                      return FinanceCategoryFilterTile(
                                        ...
                                        onTap: () =>
                                            _openCategoryFilterPicker(ordered),
                                  ...
                                  FinanceFilterSearchField(
                                    ...
                                    hintText:
                                        'Buscar descrição, categoria ou conta…',
                    ...
                    final hPad = math.max(
                        12.0, (MediaQuery.sizeOf(context).width - 920) / 2);
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    hasMoreTx
                                        ? '${docsVisible.length} de ${docs.length} lançamentos'
                                        : '${docs.length} lançamento(s)',
                                    style: TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.w800,
                                        color: context.appTextPrimary),
                                            ...
                                            onPressed: () async {
                                              final confirm =
                                                ...
                                                builder: (ctx) => AlertDialog(
                                                  ...
                                                  content: Text(
                                                      '${_gridSelectedIds.length} lançamento(s). Esta ação não pode ser desfeita.'),
                                                  actions: [
                                                    TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                      ...
                      child: CustomScrollView(
                        ...
                        slivers: [
                          ...
                          if (docs.isEmpty)
                            ...
                            SliverPadding(
                              padding:
                                  EdgeInsets.fromLTRB(12, 0, 12, bottomPad),
                              sliver: SliverList(
                                delegate: SliverChildBuilderDelegate(
                                  (context, index) {
                                    if (hasMoreTx &&
                                        index == docsVisible.length) {
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 12),
                                        child: Center(
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        if (showHeader)
                                          _dayHeader(_transactionCalendarDay(
                                              doc.data())),
                                        FinanceTransactionListTile(
                                          ...
                                          isSelected:
                                              _gridSelectedIds.contains(doc.id),
                                          ...
                                          onConfirmPayment:
                                              _confirmPaymentWithOptimistic,
                                          onAttachReceipt:
                                              widget.handlers.onAttachReceipt,
                                        ),
                                      ],
                                    );
                                  },
                                  childCount:
                                      docsVisible.length + (hasMoreTx ? 1 : 0),
                                ),
                              ),
                            ),
                        ],
