...
import 'package:gestao_yahweh/models/finance_assistant_insight.dart';
...
import 'package:gestao_yahweh/utils/finance_assistant_insights_engine.dart';
import 'package:gestao_yahweh/utils/finance_period_summary.dart';
import 'package:gestao_yahweh/utils/finance_smart_tips_composer.dart';
import 'package:gestao_yahweh/utils/finance_tip_bank_selector.dart';
            ...
            return ListView(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16, color: context.appTextPrimary),
                ),
                SizedBox(height: 20),
          ...
          return ListView(
            ...
            children: [
              ...
              if (alerts.isEmpty)
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 13, color: context.appTextSecondary, height: 1.35),
                  ),
                )
              else
              ...
              Text(
                ...
                style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w600, color: context.appTextSecondary),
              ),
              SizedBox(height: 10),
              if (tips.isEmpty)
                Text('Sem dicas neste momento.', style: TextStyle(color: context.appTextSecondary))
              else
                ...tips.map((t) => Padding(
                      padding: const EdgeInsets.only(bottom: 10),
              ...
              SizedBox(height: 10),
              if (bankTips.isEmpty)
                Text('Nenhuma dica do banco para exibir.', style: TextStyle(color: context.appTextSecondary))
              else
