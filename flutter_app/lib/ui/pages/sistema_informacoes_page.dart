...
const _kSistemaModulosResumo = <_SistemaModuloResumo>[
  ...
  _SistemaModuloResumo(
    shellIndex: ChurchShellIndices.minhaEscala,
    description: 'Escala unificada da igreja e seus compromissos',
  ),
  _SistemaModuloResumo(
...
class _SistemaInformacoesPageState extends State<SistemaInformacoesPage> {
  ...
  Future<void> _enviarSugestao() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Sua sugestão foi enviada. Obrigado!'),
                    ...
                    Row(
                      ...
                      children: [
                        ChurchShellNavIcon3D(
                          icon:
                              kChurchShellNavEntries[ChurchShellIndices
                                      .informacoes]
                                  .icon,
                          accent:
                              kChurchShellNavEntries[ChurchShellIndices
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            YahwehWisdomVisualKit.navyMid.withValues(
                              alpha: 0.08,
                            ),
                            YahwehWisdomVisualKit.tealAccent.withValues(
                              alpha: 0.06,
                            ),
                          ],
                        ),
                        ...
                        border: Border.all(
                          color: YahwehWisdomVisualKit.tealAccent.withValues(
                            alpha: 0.22,
                          ),
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Obrigado! Você receberá um retorno em breve.',
                                style: TextStyle(
                                  color: Colors.green.shade700,
                                  fontWeight: FontWeight.w600,
                                ),
  ...
  Widget _buildModulosResumoGrid(BuildContext context) {
    ...
    return Column(
      children: [for (final m in _kSistemaModulosResumo) _buildModuloCard(m)],
    );
  }
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          fmt(data['createdAt'] as Timestamp?),
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.grey.shade600,
                          ),
