...
class _CategoriesConfigScreenState extends State<CategoriesConfigScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Categorias', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18, letterSpacing: -0.2)),
        elevation: 0,
          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: context.isDarkMode
                ...
                border: Border.all(color: context.appDeepTitle.withValues(alpha: 0.14)),
                boxShadow: [
                  BoxShadow(
                    color: context.appDeepTitle.withValues(alpha: 0.06),
                    blurRadius: 12,
          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: context.appDeepTitle.withValues(alpha: 0.25),
                    blurRadius: 14,
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.visibility_off_rounded, color: context.appTextMuted, size: 22),
                        SizedBox(width: 12),
                        Expanded(
                          child: Text(
                            name,
                        ...
                        FilledButton.tonal(
                          ...
                          child: Text('Repor', style: TextStyle(fontWeight: FontWeight.w900)),
                        ),
                      ],
                    ),
                  ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isDefault
                      ? const Color(0xFF3949AB).withValues(alpha: isDark ? 0.55 : 0.25)
                      : const Color(0xFF00695C).withValues(alpha: isDark ? 0.55 : 0.25),
                ),
              ),
              child: Text(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: context.isDarkMode
                  ...
                  : context.appDeepTitle.withValues(alpha: 0.1),
            ),
            boxShadow: [
              BoxShadow(
                color: vis.color.withValues(alpha: context.isDarkMode ? 0.16 : 0.08),
                blurRadius: 12,
                offset: const Offset(0, 3),
              ),
            ],
