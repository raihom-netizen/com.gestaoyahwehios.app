...
class ControleFinanceiroScreen extends StatefulWidget {
  ...
  @override
  State<ControleFinanceiroScreen> createState() =>
      _ControleFinanceiroScreenState();
}
...
class _ControleFinanceiroScreenState extends State<ControleFinanceiroScreen> {
  ...
  Widget _buildRecentTransactions() => Column(
        children: [
          _transactionTile(
              'Mercado Pago', 'R\$ 49,90', 'Hoje', Colors.blue, Icons.payment),
          _transactionTile('Venda Software', 'R\$ 1.200,00', 'Ontem',
              Colors.green, Icons.arrow_upward),
        ],
      );

  Widget _transactionTile(String t, String v, String d, Color c, IconData i) =>
      Container(
        ...
        child: Row(
          children: [
            ...
            Text(v,
                style: TextStyle(
                    color:
                        c == Colors.green ? Colors.greenAccent : Colors.white,
                    fontWeight: FontWeight.bold)),
          ],
        ),
      );
