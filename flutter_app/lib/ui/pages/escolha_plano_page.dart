...
import 'package:gestao_yahweh/models/landing_public_content.dart';
...
import 'package:gestao_yahweh/utils/navigator_safe_pop.dart';
import 'package:gestao_yahweh/ui/widgets/divulgacao_public_promo_card.dart';
import 'package:gestao_yahweh/ui/widgets/plan_change_acknowledgment_card.dart';
import 'package:gestao_yahweh/ui/widgets/plan_change_contract_sheet.dart';
...
class _EscolhaPlanoPageState extends State<EscolhaPlanoPage> {
  ...
  Future<void> _loadPromo(String id) async {
    ...
    try {
      ...
      if (_openMpCheckoutAfterPromoLoad && !_autoPromoCheckoutOpened) {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                    fontSize: 13, color: context.appTextPrimary, height: 1.35),
              ),
            ],
          ),
        ),
            ...
            builder: (context, landSnap) {
              return StreamBuilder<MpCheckoutPricingSnapshot>(
                ...
                builder: (context, pricingSnap) {
                  final p =
                      pricingSnap.data ?? MpCheckoutPricingSnapshot.defaults();
                  final landing =
                      LandingPublicContent.fromMap(landSnap.data?.data())
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            AbsorbPointer(
                              ...
                              child: Opacity(
                                  opacity: _promoData != null ? 0.45 : 1,
                            ...
                            _buildPlanoCard(
                              ...
                              notaAnual: _promoData != null
                                  ...
                                  : (_isAnual
                                      ...
                                      : null),
                              beneficios:
                                  landing.divPremiumBeneficiosList.isNotEmpty
                            ...
                            PlanChangeAcknowledgmentCard(
                              ...
                              onAcceptedChanged: (v) =>
                                  setState(() => _acceptedPlanChangeTerms = v),
                            ),
                            SizedBox(height: 24),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(25),
            border: selecionado
                ? Border.all(color: const Color(0xFF6D4DFF), width: 3)
                : null,
            boxShadow: [
              if (isPremium)
                BoxShadow(
              ...
              if (selecionado)
                BoxShadow(
                    color: const Color(0xFF6D4DFF).withValues(alpha: 0.30),
                    blurRadius: 14,
                    offset: const Offset(0, 4)),
            ],
          ),
          child: Column(
            ...
            children: [
              ...
              if (isPremium) SizedBox(height: 4),
              Text(
                nome,
                maxLines: 2,
  ...
  Widget _buildPaymentSelection() {
    return Column(
      ...
      children: [
        ...
        _paymentTile(
          _isAnual
              ? 'Cartão de crédito (anual em até 6x no Mercado Pago)'
              : 'Cartão de crédito',
        ...
        DecoratedBox(
          ...
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(20),
              onTap: _acceptedPlanChangeTerms
                  ? _confirmarPagamento
                  : _onAssinarSemAceite,
              child: Container(
                ...
                child: Text(
                  _acceptedPlanChangeTerms
                      ? 'Assinar agora'
                      : 'Assinar agora (aceite o termo acima)',
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
  ...
  void _onAssinarSemAceite() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            'Marque a confirmação no quadro acima e, se quiser, leia o termo completo antes de pagar.'),
  ...
  void _confirmarPagamento() {
    if (_promoData != null && _promoIdFromUrl != null) {
      final promo = PublicDivulgacaoPromo.fromLoadedPromotionDoc(
          _promoIdFromUrl!, _promoData!);
      openPublicPromoMercadoPagoCheckout(context, promo);
      return;
    }
