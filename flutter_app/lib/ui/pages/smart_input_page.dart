...
import 'package:gestao_yahweh/services/smart_input_pdf_text_service.dart';
...
import 'package:gestao_yahweh/utils/smart_input_heavy_parse.dart';
import 'package:gestao_yahweh/utils/smart_input_voice_text.dart';
...
import 'smart_input_batch_preview_page.dart';
...
class _SmartInputScreenState extends State<SmartInputScreen> {
  ...
  /// Se true e o lançamento for pendente, aparece no calendário Agenda/Escala.
  bool _addToCalendar = false;

  /// Cor que o lançamento exibirá no calendário. Null = padrão do tipo.
  ...
  Future<void> _shareCsvTemplate() async {
    ...
    try {
      await Share.shareXFiles(
        ...
        subject: 'Modelo CSV — Controle Total',
      );
    } catch (_) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Lançamento inteligente'),
          centerTitle: true,
                      ...
                      children: [
                        ...
                        if (_undoFieldSnapshot != null) ...[
                          ...
                          Align(
                            ...
                            child: TextButton.icon(
                              ...
                              label: Text('Desfazer colagem ou import'),
                        ...
                        SizedBox(
                          ...
                          child: FilledButton.icon(
                            ...
                            icon: Icon(Icons.auto_fix_high_rounded, size: 22),
                            label: Text('Gerar lançamentos',
                                style: TextStyle(
                                    fontWeight: FontWeight.w900,
                                    fontSize: 15,
                                    letterSpacing: 0.15)),
...
class _ConfirmCard extends StatelessWidget {
  ...
  Widget _buildCalendarColorButton(BuildContext context) {
    ...
    final currentHex = calendarColorHex ?? defaultHex;
    var clean = currentHex
        .replaceFirst('#', '')
