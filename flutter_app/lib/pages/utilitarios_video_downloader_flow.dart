    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'YouTube · Instagram · TikTok · Facebook\nCole o link → baixe → salve ou compartilhe\nMP4/MP3 · 100% local · rápido',
            textAlign: TextAlign.center,
      ...
      child: Row(
        children: [
          ...
          Padding(
            ...
            child: IconButton(
              tooltip: 'Colar link',
              icon: const Icon(Icons.paste_rounded, size: 22),
    ...
    return Column(
      children: [
        ...
        SizedBox(
          ...
          child: FilledButton.icon(
            onPressed:
                _busy || !validUrl ? null : () => _download(audioOnly: true),
            icon: const Icon(Icons.audiotrack_rounded, size: 20),
            label: const Text('Baixar só Áudio MP3'),
            style: FilledButton.styleFrom(
              minimumSize: const Size(0, 50),
