...
class FunctionsService {
  ...
  Future<Map<String, dynamic>> createCheckout(
      {required String plan, String? promoId}) async {
    final res = await _fn.httpsCallable('ctCreateMpCheckout').call({
      'plan': plan,
      if (promoId != null && promoId.trim().isNotEmpty)
  ...
  Future<Map<String, dynamic>> createPluggyConnectToken(
  ...
  Future<Map<String, dynamic>> createFirebaseBackup() async {
    final res = await _fn
        .httpsCallable('ctCreateFirebaseBackup')
        .call<Map<String, dynamic>>({});
    return Map<String, dynamic>.from(res.data as Map);
  }
  ...
  Future<Map<String, dynamic>> listFirebaseBackups() async {
    final res = await _fn
        .httpsCallable('ctListFirebaseBackups')
        .call<Map<String, dynamic>>({});
    return Map<String, dynamic>.from(res.data as Map);
  }

  /// Retorna URL assinada para download do backup (admin).
  Future<Map<String, dynamic>> getFirebaseBackupDownloadUrl(
      {required String path}) async {
    final res = await _fn
        .httpsCallable('ctGetFirebaseBackupDownloadUrl')
  ...
  Future<Map<String, dynamic>> restoreFirebaseBackup(
      {required String path}) async {
    final res = await _fn
        .httpsCallable('ctRestoreFirebaseBackup')
        .call<Map<String, dynamic>>({'path': path});
    return Map<String, dynamic>.from(res.data as Map);
  }
  ...
  Future<Map<String, dynamic>> createFinanceTransfer({
    ...
    final res = await _fn
        .httpsCallable('ctFinanceCreateTransfer')
        .call<Map<String, dynamic>>({
      'amount': amount,
  ...
  Future<Map<String, dynamic>> getFinanceTransferPair(
      {required String pairId}) async {
    final res = await _fn
        .httpsCallable('ctFinanceGetTransferPair')
        .call<Map<String, dynamic>>({
      'pairId': pairId,
    });
    return Map<String, dynamic>.from(res.data as Map);
  ...
  Future<Map<String, dynamic>> logDomainAccess() async {
    try {
      final res = await _fn
          .httpsCallable('ctLogDomainAccess')
          .call<Map<String, dynamic>>({});
      return Map<String, dynamic>.from(res.data as Map);
    } catch (_) {
      return {};
  ...
  Future<String?> ocrImageForSmartInput(
      {required String base64, String mimeType = 'image/jpeg'}) async {
  ...
  Future<Map<String, dynamic>> getDomainAccessStats(
      {required String period, String? dateISO}) async {
    final res = await _fn
        .httpsCallable('ctGetDomainAccessStats')
        .call<Map<String, dynamic>>({
      'period': period,
      'dateISO': ?dateISO,
    });
  ...
  Future<Map<String, dynamic>?> generateBudgetWithAI(String description) async {
    final res = await _fn
        .httpsCallable('ctGenerateBudgetWithAI')
  ...
  Future<Map<String, dynamic>> removeEmailsFromPartnership({
    ...
    final res = await _fn
        .httpsCallable('ctRemoveEmailsFromPartnership')
        .call<Map<String, dynamic>>({
  ...
  Future<Map<String, dynamic>> bulkMigrateUsersToPartnership({
    ...
    final res = await _fn
        .httpsCallable('ctBulkMigrateUsersToPartnership')
        .call<Map<String, dynamic>>({
      'partnershipId': partnershipId.trim().toLowerCase(),
      'uids': uids,
  ...
  Future<Map<String, dynamic>> syncPartnershipCsvSource({
    ...
    final res = await _fn
        .httpsCallable('ctSyncPartnershipCsvSource')
        .call<Map<String, dynamic>>({
      'partnershipId': partnershipId.trim().toLowerCase(),
  ...
  Future<Map<String, dynamic>> importPartnershipCsvManual({
    ...
    final res = await _fn
        .httpsCallable('ctImportPartnershipCsvManual')
        .call<Map<String, dynamic>>({
      'partnershipId': partnershipId.trim().toLowerCase(),
      'csvText': csvText,
      if (removeMissingNotInCsv) 'removeMissingNotInCsv': true,
