...
/// Pedidos de oração — `igrejas/{id}/pedidosOracao`.
final class ChurchPedidosOracaoRepository extends ChurchModuleRepositoryBase {
  const ChurchPedidosOracaoRepository()
      : super(
          moduleLabel: 'Pedidos de Oração',
          subcollection: ChurchDataPaths.pedidosOracao,
        );

  static const ChurchPedidosOracaoRepository instance =
      ChurchPedidosOracaoRepository();
  ...
  Future<ChurchDataListResult<QueryDocumentSnapshot<Map<String, dynamic>>>>
    ...
    try {
      final snap = await TenantStaleWhileRevalidate.loadQuery(
        tenantId: id,
        module: TenantModuleKeys.pedidosOracao,
