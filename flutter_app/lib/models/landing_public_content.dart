import 'package:gestao_yahweh/services/mp_checkout_pricing_service.dart';
...
const List<LandingFieldDef> kDivulgacaoLandingFields = [
  LandingFieldDef('divHeroTitle', 'Hero — título principal', 'Controle Total'),
  LandingFieldDef('divHeroTagline', 'Hero — linha ciano (ex.: Premium · Controle Total)', 'Premium · Controle Total'),
  LandingFieldDef('divHeroBadge', 'Hero — faixa (badge)', 'EXPERIÊNCIA SUPER PREMIUM'),
  LandingFieldDef(
    'divHeroHeadline',
    'Hero — parágrafo (branco)',
    'Uma conta: finanças, escalas e metas — no celular ou no computador.',
  ),
  ...
  LandingFieldDef('divChannelsTitle', 'Canais oficiais — título', 'Canais oficiais'),
  LandingFieldDef('divChannelsSubtitle', 'Canais oficiais — subtítulo', 'Raihom Barbosa'),
  LandingFieldDef(
    'divYoutubeUrl',
  ...
  LandingFieldDef(
    ...
    'https://wa.me/5562991705247',
  ),
  LandingFieldDef('divLabelComoFunciona', 'Seção — rótulo “Como funciona”', 'Como funciona'),
  ...
  LandingFieldDef('divStep2Title', 'Passo 2 — título', 'Escolha o plano no site'),
  LandingFieldDef(
    'divStep2Body',
    'Passo 2 — texto',
  ...
  LandingFieldDef('divLabelComece', 'Seção — rótulo “Comece aqui”', 'Comece aqui'),
  LandingFieldDef(
    'divComeceParagraph',
  ...
  LandingFieldDef(
    'divPlanosSubtitle',
    'Planos — subtítulo',
    r'Plano Premium: finanças, metas e escalas num só lugar. Pague mensal ou anual — no anual, melhor custo-benefício; recomendamos o anual. No cartão, o plano anual pode ser parcelado em até 6 vezes quando o Mercado Pago permitir.',
  ),
  LandingFieldDef('divBasicoTitulo', 'Bloco secundário — título (opcional)', 'Destaque'),
  LandingFieldDef('divBasicoMensal', 'Bloco secundário — linha mensal', r'R$ 14,99/mês'),
  LandingFieldDef('divBasicoAnual', 'Bloco secundário — linha anual', r'R$ 169,90/ano'),
  LandingFieldDef(
    'divBasicoBeneficios',
    'Bloco secundário — benefícios (vírgula)',
    'Controle financeiro, Gestão de escalas, Calculadora de plantão, Alertas personalizados',
  ),
  LandingFieldDef('divPremiumTitulo', 'Plano Premium — nome', 'Premium'),
  LandingFieldDef('divPremiumMensal', 'Plano Premium — linha mensal', r'R$ 14,99/mês'),
  LandingFieldDef('divPremiumAnual', 'Plano Premium — linha anual', r'R$ 169,90/ano'),
  LandingFieldDef(
    'divPremiumBeneficios',
    'Plano Premium — benefícios (vírgula)',
    'Finanças, metas e escalas com lançamentos e controles completos, Gráficos e relatórios, Comprovantes e backup, Gestão completa num só lugar',
  ),
  LandingFieldDef(
    'divPremiumCardSubtitle',
    'Cartão Premium — subtítulo (cinza)',
    'Finanças, metas e escalas com controlo total à mão',
  ),
  LandingFieldDef('divPremiumRibbon', 'Cartão Premium — faixa superior', 'SUPER PREMIUM'),
  LandingFieldDef(
    'divPremiumProTitulo',
    'Plano Premium PRO — nome',
    'Premium PRO — o teu dinheiro entra sozinho no app.',
  ),
  LandingFieldDef('divPremiumProMensal', 'Plano Premium PRO — linha mensal', r'R$ 25,90/mês'),
  LandingFieldDef('divPremiumProAnual', 'Plano Premium PRO — linha anual', r'R$ 299,90/ano'),
  LandingFieldDef(
  ...
  LandingFieldDef('divIncluiLabel', 'Planos — rótulo da lista “Inclui”', 'Inclui'),
  LandingFieldDef('divGerencieTopBadge', 'Cartão licença — faixa superior', 'SUPER PREMIUM · LICENÇA'),
  LandingFieldDef('divGerencieTitle', 'Cartão licença — título', 'Gerencie sua licença'),
  LandingFieldDef(
    'divGerencieSubtitle',
  ...
  LandingFieldDef('divGerencieLoginBtn', 'Cartão licença — botão login', 'Login — e-mail ou CPF + senha'),
  LandingFieldDef('divGerencieGoogleBtn', 'Cartão licença — botão Google', 'Continuar com Google'),
  LandingFieldDef(
    'divTrialTitle',
  ...
  LandingFieldDef('divFooterDomain', 'Rodapé web — domínio', 'controletotalapp.com.br'),
  LandingFieldDef('divFooterHome', 'Rodapé web — link inicial', 'Página inicial'),
  LandingFieldDef('divFooterTerms', 'Rodapé web — Termos', 'Termos'),
  LandingFieldDef('divFooterPrivacy', 'Rodapé web — Privacidade', 'Privacidade'),
  LandingFieldDef('divBtnEntrarPrincipal', 'Botão final — Entrar', 'Entrar — Controle Total'),
  LandingFieldDef('divBtnAreaAdmin', 'Botão final — Área administrativa', 'Área administrativa'),
];
...
List<LandingFieldDef> get kDivulgacaoLandingFieldsSemPlanos => kDivulgacaoLandingFields
    .where((f) => !kDivulgacaoPlanPricingKeys.contains(f.key))
    .toList();

/// Ordem fixa dos campos de plano para o bloco “Preços” no Admin.
List<LandingFieldDef> get kDivulgacaoPlanPricingFields => kDivulgacaoLandingFields
    .where((f) => kDivulgacaoPlanPricingKeys.contains(f.key))
    .toList();

/// Defaults da seção “Página inicial /” e textos legados já usados no Admin.
const Map<String, String> kLegacyLandingDefaults = {
  'heroTitle': 'Controle Total App',
  'heroSubtitle': 'Gestão financeira, escalas e metas em um só lugar.',
  'heroTealLine': 'Sem propagandas. Limpo, seguro e pensado para você.',
  'heroSlateLine': 'Celular, computador ou notebook — acesso livre total.',
  'heroBadges':
      'Controle financeiro, Meta financeira, Escalas, Calculadora de horas extras',
  'heroNote': '',
  'plansTitle': 'Plano Premium',
  'premiumPrice': r'R$ 14,99/mês • R$ 169,90/ano',
  'masterPrice': r'R$ 14,99/mês • R$ 169,90/ano',
  'premiumPerks':
      'Controle financeiro, Gestão de escalas, Calculadora de plantão, Alertas personalizados, Anexar comprovantes, Gestão completa',
  'masterPerks':
      'Controle financeiro, Gestão de escalas, Calculadora de plantão, Alertas personalizados, Anexar comprovantes, Gestão completa',
  'planCtaText': 'Assinar agora',
  'landingPremiumDetail':
      r'Plano mensal: R$ 14,99 por mês. Plano anual: R$ 169,90/ano — frisando: comprando anual, sai R$ 14,15 por mês; é um ótimo negócio. Recomendamos comprar anual para máxima economia.',
  'landingPremiumCardPeriod':
      r'Mensal ou anual — no anual: R$ 14,15/mês, ótimo negócio; recomendamos comprar anual',
  'landingPremiumFeatures':
      'Financeiro, metas e relatórios, Escalas, calculadora e agenda, Anexar comprovantes de despesas, Acesso pelo celular, computador ou notebook (acesso livre total), Downloads e suporte',
  'footerText':
      'Sistema sem propagandas indesejáveis, limpo e seguro. Acesso pelo celular, computador ou notebook.',
  'supportTitle': 'Downloads e suporte',
  'supportSubtitle':
      'Financeiro, metas e relatórios; escalas, calculadora e agenda; anexar comprovantes; acesso total.',
};
...
class LandingPublicContent {
  ...
  String get divYoutubeLabel => 'YouTube';
  String get divInstagramLabel => 'Instagram';
  String get divWhatsappLabel => 'WhatsApp';
  ...
  factory LandingPublicContent.fromMap(Map<String, dynamic>? raw) {
    return LandingPublicContent(
      heroTitle: _pickStr(raw, 'heroTitle', _legacyDef('heroTitle')),
      heroSubtitle: _pickStr(raw, 'heroSubtitle', _legacyDef('heroSubtitle')),
      heroTealLine: _pickStr(raw, 'heroTealLine', _legacyDef('heroTealLine')),
      heroSlateLine: _pickStr(raw, 'heroSlateLine', _legacyDef('heroSlateLine')),
      plansTitle: _pickStr(raw, 'plansTitle', _legacyDef('plansTitle')),
      planCtaText: _pickStr(raw, 'planCtaText', _legacyDef('planCtaText')),
      landingPremiumDetail:
          _pickStr(raw, 'landingPremiumDetail', _legacyDef('landingPremiumDetail')),
      landingPremiumCardPeriod:
          _pickStr(raw, 'landingPremiumCardPeriod', _legacyDef('landingPremiumCardPeriod')),
      landingPremiumFeaturesCsv:
          _pickStr(raw, 'landingPremiumFeatures', _legacyDef('landingPremiumFeatures')),
      divHeroTitle: _pickStr(raw, 'divHeroTitle', _divDef('divHeroTitle')),
      divHeroTagline: _pickStr(raw, 'divHeroTagline', _divDef('divHeroTagline')),
      divHeroBadge: _pickStr(raw, 'divHeroBadge', _divDef('divHeroBadge')),
      divHeroHeadline: _pickStr(raw, 'divHeroHeadline', _divDef('divHeroHeadline')),
      divHeroBtnEntrar: _pickStr(raw, 'divHeroBtnEntrar', _divDef('divHeroBtnEntrar')),
      divHeroBtnPlanos: _pickStr(raw, 'divHeroBtnPlanos', _divDef('divHeroBtnPlanos')),
      ...
      divLabelComoFunciona: _pickStr(raw, 'divLabelComoFunciona', _divDef('divLabelComoFunciona')),
      ...
      divLabelComece: _pickStr(raw, 'divLabelComece', _divDef('divLabelComece')),
      divComeceParagraph: _pickStr(raw, 'divComeceParagraph', _divDef('divComeceParagraph')),
      divLabelPlanos: _pickStr(raw, 'divLabelPlanos', _divDef('divLabelPlanos')),
      divPlanosSubtitle: _pickStr(raw, 'divPlanosSubtitle', _divDef('divPlanosSubtitle')),
      divBasicoTitulo: _pickStr(raw, 'divBasicoTitulo', _divDef('divBasicoTitulo')),
      divBasicoMensal: _pickStr(raw, 'divBasicoMensal', _divDef('divBasicoMensal')),
      divBasicoAnual: _pickStr(raw, 'divBasicoAnual', _divDef('divBasicoAnual')),
      divBasicoBeneficiosCsv: _pickStr(raw, 'divBasicoBeneficios', _divDef('divBasicoBeneficios')),
      divPremiumTitulo: _pickStr(raw, 'divPremiumTitulo', _divDef('divPremiumTitulo')),
      divPremiumMensal: _pickStr(raw, 'divPremiumMensal', _divDef('divPremiumMensal')),
      divPremiumAnual: _pickStr(raw, 'divPremiumAnual', _divDef('divPremiumAnual')),
      divPremiumBeneficiosCsv: _pickStr(raw, 'divPremiumBeneficios', _divDef('divPremiumBeneficios')),
      divPremiumCardSubtitle: _pickStr(raw, 'divPremiumCardSubtitle', _divDef('divPremiumCardSubtitle')),
      divPremiumRibbon: _pickStr(raw, 'divPremiumRibbon', _divDef('divPremiumRibbon')),
      divPremiumProTitulo: _pickStr(raw, 'divPremiumProTitulo', _divDef('divPremiumProTitulo')),
      divPremiumProMensal: _pickStr(raw, 'divPremiumProMensal', _divDef('divPremiumProMensal')),
      divPremiumProAnual: _pickStr(raw, 'divPremiumProAnual', _divDef('divPremiumProAnual')),
      divPremiumProBeneficiosCsv:
          _pickStr(raw, 'divPremiumProBeneficios', _divDef('divPremiumProBeneficios')),
      divPremiumProCardSubtitle:
          _pickStr(raw, 'divPremiumProCardSubtitle', _divDef('divPremiumProCardSubtitle')),
      divPremiumProExtrasLine: _pickStr(raw, 'divPremiumProExtrasLine', _divDef('divPremiumProExtrasLine')),
      divPremiumProRibbon: _pickStr(raw, 'divPremiumProRibbon', _divDef('divPremiumProRibbon')),
      divIncluiLabel: _pickStr(raw, 'divIncluiLabel', _divDef('divIncluiLabel')),
      divGerencieTopBadge: _pickStr(raw, 'divGerencieTopBadge', _divDef('divGerencieTopBadge')),
      divGerencieTitle: _pickStr(raw, 'divGerencieTitle', _divDef('divGerencieTitle')),
      divGerencieSubtitle: _pickStr(raw, 'divGerencieSubtitle', _divDef('divGerencieSubtitle')),
      divGerencieTapLine: _pickStr(raw, 'divGerencieTapLine', _divDef('divGerencieTapLine')),
      divGerencieParagraph: _pickStr(raw, 'divGerencieParagraph', _divDef('divGerencieParagraph')),
      divGerencieLoginBtn: _pickStr(raw, 'divGerencieLoginBtn', _divDef('divGerencieLoginBtn')),
      divGerencieGoogleBtn: _pickStr(raw, 'divGerencieGoogleBtn', _divDef('divGerencieGoogleBtn')),
      ...
      divFooterDomain: _pickStr(raw, 'divFooterDomain', _divDef('divFooterDomain')),
      divFooterHome: _pickStr(raw, 'divFooterHome', _divDef('divFooterHome')),
      divFooterTerms: _pickStr(raw, 'divFooterTerms', _divDef('divFooterTerms')),
      divFooterPrivacy: _pickStr(raw, 'divFooterPrivacy', _divDef('divFooterPrivacy')),
      divBtnEntrarPrincipal: _pickStr(raw, 'divBtnEntrarPrincipal', _divDef('divBtnEntrarPrincipal')),
      divBtnAreaAdmin: _pickStr(raw, 'divBtnAreaAdmin', _divDef('divBtnAreaAdmin')),
    );
  }
  ...
  List<String> get divBasicoBeneficiosList => _splitBenefits(divBasicoBeneficiosCsv);
  List<String> get divPremiumBeneficiosList => _splitBenefits(divPremiumBeneficiosCsv);
  List<String> get divPremiumProBeneficiosList => _splitBenefits(divPremiumProBeneficiosCsv);
  List<String> get landingPremiumFeaturesList => _splitBenefits(landingPremiumFeaturesCsv);
  ...
  LandingPublicContent applyPremiumTextsFromCheckoutPricing(MpCheckoutPricingSnapshot snap) {
    ...
    return LandingPublicContent(
      ...
      landingPremiumCardPeriod: g['landingPremiumCardPeriod'] ?? landingPremiumCardPeriod,
      ...
      divBasicoMensal: divBasicoMensal,
      divBasicoAnual: divBasicoAnual,
      ...
      divPremiumBeneficiosCsv: g['divPremiumBeneficios'] ?? divPremiumBeneficiosCsv,
      ...
      divPremiumProExtrasLine: gp['divPremiumProExtrasLine'] ?? divPremiumProExtrasLine,
  ...
  String divTrialTitleWithDays(int days) => divTrialTitle.replaceAll('{days}', '$days');
