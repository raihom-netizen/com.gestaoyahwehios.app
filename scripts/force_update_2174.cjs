// Força atualização SEGURA para 11.2.305+2174.
// - Web: webRefresh=true -> a aba recarrega para o build novo (já live).
// - Mobile: PRESERVA minBuildNumber atual (NÃO tranca quem ainda não tem 2174
//   nas lojas Play/App Store; o AAB/iOS ainda vão ser publicados/revisados).
//   Depois que as lojas tiverem 2174, sobe-se minBuildNumber pelo painel.
