// Força atualização SEGURA para 11.2.305+2177.
// - Web: webRefresh=true -> a aba recarrega para o build novo (já live).
// - Mobile: PRESERVA minBuildNumber atual (NÃO tranca quem ainda não tem 2177
//   nas lojas Play/App Store; o AAB/iOS ainda vão ser publicados/revisados).
//   Depois que as lojas tiverem 2177, sobe-se minBuildNumber pelo painel.
