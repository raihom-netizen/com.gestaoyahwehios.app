// Força atualização SEGURA para 11.2.305+2247.
// - Web: publishedBuild=2247 -> painel oferece diálogo MANUAL "Atualizar"
//   (webRefresh é legado; na web o reload é sempre via botão do diálogo, nunca
//   automático — ver version_service.dart:236,264).
// - Mobile: PRESERVA minBuildNumber atual (NÃO tranca quem ainda não tem 2247
//   nas lojas Play/App Store; o AAB/iOS ainda vão ser publicados/revisados).
//   Depois que as lojas tiverem 2247, sobe-se minBuildNumber pelo painel.
