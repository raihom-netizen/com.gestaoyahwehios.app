$procs = Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match 'scripts\\deploy_completo\.ps1' -and $_.CommandLine -match 'deploy_completo_build2066_final\.log' }
