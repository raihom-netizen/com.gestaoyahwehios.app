// Força atualização SEGURA para 11.2.305+2246.
// - Web: publishedBuild=2246 -> painel oferece diálogo MANUAL "Atualizar"
//   (webRefresh é legado; na web o reload é sempre via botão do diálogo, nunca
//   automático — ver version_service.dart:236,264).
// - Mobile: PRESERVA minBuildNumber atual (NÃO tranca quem ainda não tem 2246
//   nas lojas Play/App Store; o AAB/iOS ainda vão ser publicados/revisados).
//   Depois que as lojas tiverem 2246, sobe-se minBuildNumber pelo painel.
