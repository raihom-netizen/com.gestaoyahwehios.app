...
**Memória única (igual Controle Total):** `PONTO_BASE_MEMORIA_2026-07-17_11.2.305+2118.md` + regra `.cursor/rules/ponto-base-memoria-11-2-305-2118.mdc`. Não criar segunda memória; ao atualizar release, substituir este ficheiro e apagar o anterior.
